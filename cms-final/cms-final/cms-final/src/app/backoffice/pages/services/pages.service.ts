...
const MOCK_PAGES: Page[] = [
  {
    ...
    blocks: [
      {
        id: 'h1', type: 'hero', visible: true, order: 1,
        data: { title: 'Clínica de Obstetricia y Ginecología', subtitle: 'Cuidamos de ti y de tu bebé.', ctaLabel: 'Agendar consulta', ctaRoute: '/contacto' }
      },
      {
        id: 'c1', type: 'cards-grid', visible: true, order: 2,
        data: { title: 'Nuestros servicios', columns: 3, cards: [
  ...
  },
  {
    ...
    blocks: [
      {
        id: 't1', type: 'text', visible: true, order: 1,
        data: { title: 'Nuestros servicios', html: '<p>Ofrecemos atención integral en obstetricia y ginecología.</p>', align: 'center' }
      }
    ],
